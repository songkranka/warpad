    ...
    if (data != null) {
        if (data.result.length > 0) {
            data.result.forEach(field => {
                let res = {
                    "SlaId": field.dataValues.SlaId,
                    "SlaName": field.dataValues.SlaName,
                    "SlaTime": field.dataValues.SlaTime,
                    "Status": field.dataValues.Status,
                    "CreateDate": field.dataValues.CreateDate
                }
                dataArray.push(res);
            });
        }
